<template>
	<div class="money">
						...
						<el-collapse-transition>
							<div v-show="imgRotate.includes(key)">
								<ul @click="setIconClassArr(data)" :key="i" v-for="(data, i) in item.data" class="table clearfix bj bortopnone">
									...
									<li class="three">{{data.count}}</li>
									<li class="four bor-none">{{data.price * Math.floor(data.count)}}</li>
								</ul>
							</div>
						</el-collapse-transition>
					</div>
        ...
        <table id="tab" style="border-color:#f2f2f2;" border="1">
          ...
          <!-- <p @click="setConsumpItemNone" style="wdith:140px;" class="middle addbtn">
						<span style="font-size: 16px;" class="middle">＋</span>
						<span style="cursor: pointer;" class="middle">添加其他消费项</span>
					</p> -->
				</div>
				...
				<footer class="clearfix box-pre">
					<!-- <p class="footdo">处理</p> -->
          <div style="color:#000;background:#fff;zIndex:-999;" id="print" ref="print" class="alert-box">
            <div class="box">
              <p style="fontSize:22px;textAlign:center;font-family: SimSun;">U+电竞智慧酒店</p>
              <p style="fontSize:22px;textAlign:center;marginTop:12px;marginBottom:28px;font-family: SimSun;">明细账单</p>
              <p style="marginBottom:5px;font-size: 9px;font-family:STXihei;">
                <span>打印时间：</span>
                <span>2018-10-1-01 12:11:22</span>
              </p>
              <p style="font-size: 9px;font-family:STXihei;">
                <span>订单编号：</span>
                <span>2121121131321231312313</span>
              </p>
              <p style="width: 100%;border-bottom: 1px dashed #000;margin: 18px 0;"></p>
              <p style="marginBottom:5px;font-size: 9px;font-family:STXihei;">
                <span>入住人：</span>
                <span>黑旋风</span>
              </p>
              ...
              <p style="marginBottom:5px;font-size: 9px;">
                <span>房号：</span>
                <span>001002</span>
              </p>
              <p style="marginBottom:5px;font-size: 9px;">
              ...
              <table style="font-size: 9px;" border="0">
                <tbody>
                  <tr>
                    <td style="width:34px;textAlign:left;">时间</td>
                    <td style="textAlign:center;width:54px;">房号</td>
                    <td style="textAlign:left;" colspan="5">项目</td>
                    <td style="textAlign:left;" colspan="3">金额</td>
                  </tr>
                  <tr>
                    <td style="width:34px;textAlign:left;">10.10</td>
                    <td style="textAlign:center;width:54px;">1005</td>
                    <td style="textAlign:left;" colspan="5">金额金额金额金额金额金额金额金额</td>
                    <td style="textAlign:left;" colspan="3">9999.00</td>
                  </tr>
                  <tr>
                    <td style="width:34px;textAlign:left;">10.10</td>
                    <td style="textAlign:center;width:54px;">1005</td>
                    <td style="textAlign:left;" colspan="5">金额金额金额金额</td>
                    <td style="textAlign:left;" colspan="3">9999.00</td>
                  </tr>
                </tbody>
              </table>
              <p style="width: 100%;border-bottom: 1px dashed #000;margin: 18px 0;"></p>
              <p style="textAlign:right;font-size: 9px;marginBottom:5px;">
                <span style="width:166px;textAlign:left;" class="middle clearfix">
                  <span class="fl">房费合计：</span>
                  <span class="fr">10000.00</span>
                </span>
              </p>
              <p style="textAlign:right;font-size: 9px;marginBottom:5px;">
                <span style="width:166px;textAlign:left;" class="middle clearfix">
                  <span class="fl">客房消费合计：</span>
                  <span class="fr">99999.00</span>
                </span>
              </p>
              <p style="textAlign:right;font-size: 9px;marginBottom:5px;">
                <span style="width:166px;textAlign:left;" class="middle clearfix">
                  <span class="fl">总消费合计：</span>
                  <span class="fr">00.00</span>
                </span>
              </p>
              <p style="width: 100%;border-bottom: 1px dashed #000;margin: 18px 0;"></p>
              <p style="textAlign:right;font-size: 9px;marginBottom:5px;">
                <span style="width:166px;textAlign:left;" class="middle clearfix">
                  <span class="fl">付款合计：</span>
                  <span class="fr">10000.00</span>
                </span>
              </p>
              <p style="textAlign:right;font-size: 9px;marginBottom:5px;">
              ...
              <p style="textAlign:right;font-size: 9px;marginBottom:5px;">
                <span style="width:166px;textAlign:left;" class="middle clearfix">
                  <span class="fl">会员卡余额</span>
                  <span class="fr">00.00</span>
                </span>
              </p>
              <p style="marginTop:50px;font-size: 9px;">
                <span>宾客签名：</span>
              </p>
              <p style="width: 100%;border-bottom: 1px dashed #000;margin: 18px 0;"></p>
              <p style="font-size: 9px;marginBottom:5px;">
                <span style="width:70px;" class="middle">收银员：</span>
                <span>007</span>
              </p>
              <p style="font-size: 9px;marginBottom:5px;">
                <span style="width:70px;" class="middle">前台电话：</span>
                <span>007007007007007007007007</span>
              </p>
              <p style="font-size: 9px;marginBottom:5px;">
                <span style="width:70px;marginBottom:5px;" class="middle">地址：</span>
                <span>前台电话：前台电话：前台电话：前台电话：前台电话：</span>
              </p>
              <p style="width: 100%margin: 18px auto;font-size: 9px;display:flex;justify-content:center;align-items:center;">
                <span style="flex:1;height:1px;background:#000;verticalAlign:middle;"></span>  <!--width:76px;-->
                <span>&nbsp;</span>
                <span class="middle">欢</span>
                <span>&nbsp;</span>
                <span class="middle">迎</span>
                <span>&nbsp;</span>
                <span class="middle">下</span>
                <span>&nbsp;</span>
                <span class="middle">次</span>
                <span>&nbsp;</span>
                <span class="middle">光</span>
                <span>&nbsp;</span>
                <span class="middle">临</span>
                <span>&nbsp;</span>
                <span style="flex:1;height:1px;background:#000;verticalAlign:middle;"></span>
              </p>
            </div>
