  ...
  <div class="aunt-container">
    <div class="box bg-fff" v-if="auntbox">
      ...
      <!-- <div class="assign-box">
        <el-button type="primary" size="medium" :plain="assignRoomList.length > 0 ?false:true" @click="assignAunt()">确定</el-button>
      </div> -->
    </div>
    <div class="box" v-else>
      <span class="empty">暂未添加保洁人员，
        <router-link tag="span" class="to-staff" to="/layerContainer/staffManagement">添加</router-link>以后进行指派</span>
    </div>
  </div>
</template>
