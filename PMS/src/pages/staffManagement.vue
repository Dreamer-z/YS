        ...
        >
          <template slot-scope="scope">
            ...
            >
              <el-button
                type="text"
                @click="scope.row.disable = !scope.row.disable"
      ...
      >
        ...
        >
          <el-input
            ...
            @change="userReg(newStaff.username)"
            :placeholder="userRegMsg"
            size="small"
          ></el-input>
        </el-form-item>
        <el-form-item
        ...
        >
          <el-select
            v-model="newStaff.department_id"
            placeholder="请选择"
            size="small"
          >
            <el-option
        ...
        >
          <el-input
            ...
            type="tel"
            @change="telReg(newStaff.tel)"
            :placeholder="telRegMsg"
            size="small"
          ></el-input>
        </el-form-item>
        <el-form-item
        ...
        >
          <el-input
            ...
            type="email"
            @change="emailReg(newStaff.email)"
            :placeholder="emailRegMsg"
            size="small"
          ></el-input>
        </el-form-item>
        <el-form-item
        ...
        >
          <el-input
            v-model="newStaff.idcard"
            type="text"
            @change="idReg(newStaff.idcard)"
            :placeholder="idRegMsg"
            size="small"
          ></el-input>
        </el-form-item>
        <el-form-item
        ...
        >
          <el-input
            ...
            @change="password(newStaff.password)"
            type="text"
            size="small"
          ></el-input>
        </el-form-item>
    ...
    return {
      ...
      rules: {
        ...
        password: [
          {
            required: true,
            message: "请输入至少6位数字、英文密码",
            trigger: "change"
          },
          { min: 6, message: "请填写正确身份证号码", trigger: "blur" }
        ]
      },
      userRegMsg: "",
      telRegMsg: "",
  ...
  methods: {
    ...
    userReg(account) {
      if (!Reg.account(account)) {
        ...
        this.userRegMsg = "请用6-20位数字字母和_、.、@的组合";
      } else {
        this.userRegMsg = "";
      }
    },
          ...
          API.addStaff({
            ...
            .then(function(res) {
              if (res.error_code == 0) {
                ...
                _this.$message({
                  type: "warning",
                  message: res.msg ? res.msg : "请检查信息是否有误！"
                });
              }
            })
            .catch(function(err) {
